...
def create_point_geom(x_code,y_code):
 ...
 return point
#create function, object and return point.
...
def create_line_geom (points):
  ...
  assert type(points[0])==tuple,"All list values should be Shapely Point objects!"
  line=LineString(points)
  return line
#Create a function ,takes a list,returns a LineString object,
...
#define two points and store the result in line1
...
points2=[(45.2,22.34),(100.22,-3.20),(70.0,10.20)]
poly1 = create_poly_geom(points2)
